...
# manual encoding untuk setiap kolom kategorikal
...
# fungsi get_value untuk mendapatkan nilai numerik dari nilai kategorikal yg dipilih user
...
def run_ml_app():
    ...
    avg_training = st.number_input("Average Training Score", 1,100)

    # menampilkan input yg dipilih user
    ...
    if prediction == 1:
        st.success("Congratulations, you get promotion!")
